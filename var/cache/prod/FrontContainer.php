...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '8889', 'dbname' => 'prestandbox', 'user' => 'prestandbox', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestandbox/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestandbox/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestandbox/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestandbox/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestandbox/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Applications/MAMP/htdocs/prestandbox/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_fae94e15b382984d813675d40fb5f27c96dded855a5d10a8c769e734a0aa2273');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/MAMP/htdocs/prestandbox/var/cache/prod//localization');
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.7', '/Applications/MAMP/htdocs/prestandbox', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.7', '/Applications/MAMP/htdocs/prestandbox');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/MAMP/htdocs/prestandbox/app',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/prestandbox',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/prestandbox/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                62 => 'ps_facetedsearch',
                63 => 'youtube_video',
                64 => 'Mindfruits_Configurateur',
            ],
            'ps_cache_dir' => '/Applications/MAMP/htdocs/prestandbox/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/prestandbox/var/cache/prod//doctrine/orm/Proxies',
